...
A WhatsApp assistant powered by a LangGraph agentic workflow. This project integrates persistent conversational memory via PostgreSQL, real-time messaging via FastAPI, Retrieval-Augmented Generation (RAG) for querying complex documents, and native multimodal processing for voice notes and images.
